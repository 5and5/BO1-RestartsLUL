...
include_weapons()
{
	...
	//	Weapons - Special
	include_weapon( "zombie_cymbal_monkey", true , false, maps\_zombiemode_weapons::shang_cymbal_monkey_weighting_func );
	include_weapon( "ray_gun_zm" );
	include_weapon( "ray_gun_upgraded_zm", false );
	include_weapon( "shrink_ray_zm", true, false, maps\_zombiemode_weapons::shang_babygun_weighting_func );
